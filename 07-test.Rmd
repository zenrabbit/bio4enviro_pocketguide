...
(a) list solutions beginning with the most evident in descending relevance order (exactly like you did every practice day),  
(b) propose and explain the rers that is most relevant based on research,  
(c) cite the research you did to design your rers by providing the citation to two solution papers and include just a single sentence for each explaining why you selected that paper as evidence.  
