...
If you are electing to engage with this learning opportunity formally for BIOL4265 at York University, here is the \href{https://figshare.com/articles/online_resource/BIOL4265-2021_course_outline/14962998}{official course outline}.
...
\addcontentsline{toc}{subsubsection}{Steps for test prep}
...
\tightlist
\item
  Read \href{https://cdnsciencepub.com/doi/10.1139/cjfas-2016-0520\#.W6Uwoy-ZMWo}{this paper} \citep{RN6387}.
\item
...
\tightlist
\item
  Describe the environmental management challenge case associated with this topic and publication. In the summary, please ensure that you cover the following:
\end{enumerate}
...
\tightlist
\item
  Describe why this is not an environmental management challenge -- i.e.~play the `devil's advocate' because we know this happens all the time or more fairly every environmental issue is a balance between direct and indirect benefits from a natural system. Do not use fallacious arguments or \emph{ad hominem} to do this. Use the following lines of argument:
\end{enumerate}
...
\tightlist
\item
  Reverse engineer a general, replicable solution to this challenge.
\end{enumerate}
...
\tightlist
\item
  list solutions beginning with the most evident in descending relevance order (exactly like you did every practice day),\\
\item
  propose and explain the rers that is most relevant based on research,\\
\item
  cite the research you did to design your rers by providing the citation to two solution papers and include just a single sentence for each explaining why you selected that paper as evidence.
\end{enumerate}

total = 20 points.

\hypertarget{format-for-answers}{%
\subsection*{Format for answers}\label{format-for-answers}}
\addcontentsline{toc}{subsection}{Format for answers}
